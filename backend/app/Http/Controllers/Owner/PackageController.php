...
/**
 * Manajemen Paket — hanya Owner yang bisa akses.
...
class PackageController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            foreach ($data['items'] ?? [] as $item) {
                // Jika stock_item_id diberikan, sinkronkan item_name dengan nama stok
    ...
    // POST /owner/packages/{id}/items  — tambah item ke paket
    public function addItem(Request $request, string $id): JsonResponse
    {
        ...
        // Sinkronkan nama & satuan dari StockItem jika ada FK
    ...
    // PUT /owner/packages/{id}/items/{itemId}
    ...
    // DELETE /owner/packages/{id}/items/{itemId}
    ...
    // GET /owner/stock-items — list stok untuk dropdown saat buat/edit paket
